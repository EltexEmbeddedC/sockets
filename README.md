...
- [Задание 8. Дополнить RAW клиента из задания 7: помимо заголовков транспортного и сетевого уровней необходимо также вручную заполнить и канальный](https://github.com/EltexEmbeddedC/sockets#задание-8-дополнить-raw-клиента-из-задания-7-помимо-заголовков-транспортного-и-сетевого-уровней-необходимо-также-вручную-заполнить-и-канальный-task8)
