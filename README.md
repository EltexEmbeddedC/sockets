...
- [Задание 7. Дополнить RAW клиента из задания 6: помимо заколовка транспортного уровня необходимо также вручную заполнить и сетевой](https://github.com/EltexEmbeddedC/sockets?tab=readme-ov-file#задание-7-дополнить-raw-клиента-из-задания-6-помимо-заколовка-транспортного-уровня-необходимо-также-вручную-заполнить-и-сетевой-task7)
