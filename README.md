...
- [Задание 7. Дополнить RAW клиента из задания 6: помимо заколовка транспортного уровня необходимо также вручную заполнить и сетевой](https://github.com/EltexEmbeddedC/sockets/edit/main/README.md#задание-7-дополнить-raw-клиента-из-задания-6-помимо-заколовка-транспортного-уровня-необходимо-также-вручную-заполнить-и-сетевой-task7)
...
## Задание 7. Дополнить RAW клиента из задания 6: помимо заколовка транспортного уровня необходимо также вручную заполнить и сетевой. ([Task7](https://github.com/EltexEmbeddedC/sockets/blob/main/Task7))
